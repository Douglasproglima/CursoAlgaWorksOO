...
public class ContaReceber extends Conta{
	...
	//Implementação do método abstrato da class mãe Conta, que na verdade será
	//uma sobrescrita reforçada pela anotação @Override
	@Override
	...
	//Métodos da class, cancelar() e receber()
